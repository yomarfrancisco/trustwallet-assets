# BRICS Token Assets for Trust Wallet
...
## Key Features
- **Sovereign-Backed:** Backed by tokenized sovereign credit instruments
- **Yield-Bearing:** Generates yield through sovereign credit exposure
- **Non-Transferable:** Receipt token design prevents secondary market trading
- **Fully On-Chain:** All operations and validations occur on Ethereum mainnet
...
- `info.json` - Token metadata and links
